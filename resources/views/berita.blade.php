...
<section class="hero w-120">
    <div class="hero__content">
        <div class="hero__text">
            <h1 class="hero__title">Berita Pendakian Gunung Terbaru di Jawa Tengah</h1>
            <p class="hero__description">
                Tetap Terinformasi dengan Berita Pendakian Terkini dan Kisah Inspiratif dari Para Pendaki di Jawa Tengah!
            </p>
            <a href="{{ route('login') }}" class="btn btn__hero">Lihat Berita</a>
        </div>
        <div class="hero__img">
            <img src="{{ asset('assets/img/news-hero.png') }}" alt="">
        </div>
    </div>
</section>
